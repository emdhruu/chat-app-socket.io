...
router.post(
  "/removeFriend/:userId",
  protectRoute,
  UserControllerClass.removeFriend
);
...
router.post(
  ...
  protectRoute,
  UserControllerClass.sendFriendRequest
);
router.post(
  "/acceptRequest/:friendId",
  protectRoute,
  UserControllerClass.acceptFriendRequest
);
router.post(
  "/rejectRequest/:friendId",
  protectRoute,
  UserControllerClass.rejectFriendRequest
);
...
router.get(
  ...
  protectRoute,
  UserControllerClass.requestStatus
);

router.get(
  "/search",
  protectRoute,
  UserControllerClass.getUserForSearch
);
